...
str_const14:
	...
	.word	String_dispTab
	.word	int_const13
	.ascii	"Commands: number (Operands) \n + (Add numbers) \n s (Swap numbers) \n e (Evaluate) \n d (Display) \n x (Exit) \n"
	.byte	0	
	.align	2
	.word	-1
str_const13:
...
class_objTab:
	...
	.word	A2I_protObj
	.word	A2I_init
	.word	Linked_list_protObj
	.word	Linked_list_init
	.word	Main_protObj
	.word	Main_init
Object_dispTab:
	# method # 0
...
Linked_list_dispTab:
	...
	.word	IO.in_int
	# method # 7
	.word	Linked_list.head
	# method # 8
	.word	Linked_list.get_next
	# method # 9
	.word	Linked_list.size
	# method # 10
	.word	Linked_list.push
	# method # 11
	.word	Linked_list.pop
	# method # 12
	.word	Linked_list.print
Main_dispTab:
	# method # 0
	.word	Object.abort
	# method # 1
...
Linked_list_protObj:
	.word	6	# class tag
	.word	7	# size
	.word	Linked_list_dispTab
	.word	0	# void
	.word	str_const11	# str()
	.word	str_const11	# str()
	.word	int_const0	# int(0)
	.word	-1
Main_protObj:
...
Linked_list.push:
	...
	la	$a0 Linked_list_protObj
	jal	Object.copy
	jal	Linked_list_init
	# Now find the lvalue.
	# It is an attribute.
	sw	$a0 12($s0)
	# Assign. First eval the expr.
